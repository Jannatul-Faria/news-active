...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Subscribes</h4>
    ...
    <div class="row align-items-center">
        <div class="col-md-6">
            <div class="mb-3">
                <h5 class="card-title">Subscribe List <span
                        class="text-muted fw-normal ms-2">({{ count($subscribes) }})</span>
                </h5>
            </div>
        </div>
            ...
            <tbody>
                @foreach ($subscribes as $subscribe)
                    <tr>
                        ...
                        <td>{{ $subscribe->updated_at->format('d-m-y') }}</td>
                        {{-- <td>
