                        ...
                        <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>
                                        <li><img src="{{ asset('frontend') }}/img/icon/header_icon1.png"
                                                alt="">34ºc, Sunny </li>
                                        <li><img src="{{ asset('frontend') }}/img/icon/header_icon1.png"
                                                alt="">Tuesday, 18th
                                            June, 2019</li>
                ...
                <div class="header-mid d-none d-md-block">
                    <div class="container">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-xl-2  col-lg-2 col-md-2 header-flex">
                                @auth
                                    @if (Auth::user()->role == 1)
                                        <span class="p-2"><a href="{{ url('dashboard') }}">Dashboard</a></span>
                                        <span class="p-2"> <a href="{{ url('logout') }}">Logout</a></span>
                                    @else
                                        <span class="p-2"><a href="{{ url('/login') }}">Login</a></span> | <span
                                            class="p-2"> <a href="{{ url('/registration') }}">Registration</a></span>
                                    @endif
                                    @dd('gf')
                                @endauth
                            ...
                            <div class="trending-bottom">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('frontend') }}/img/trending/trending_bottom1.jpg"
                                                    alt="">
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('frontend') }}/img/trending/trending_bottom2.jpg"
                                                    alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('frontend') }}/img/trending/trending_bottom3.jpg"
                                                    alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="{{ asset('frontend') }}/img/news/whatNews1.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="{{ asset('frontend') }}/img/news/whatNews2.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                            <span class="color1">Night party</span>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="{{ asset('frontend') }}/img/news/whatNews3.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                            <span class="color1">Night party</span>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="{{ asset('frontend') }}/img/news/whatNews4.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                            <span class="color1">Night party</span>
                            ...
                            <div class="single-box">
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="{{ asset('frontend') }}/img/news/icon-fb.png"
                                                alt=""></a>
                                    </div>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="{{ asset('frontend') }}/img/news/icon-tw.png"
                                                alt=""></a>
                                    </div>
                                    <div class="follow-count">
                                        <span>8,045</span>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="{{ asset('frontend') }}/img/news/icon-ins.png"
                                                alt=""></a>
                                    </div>
                                    <div class="follow-count">
                                        <span>8,045</span>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="{{ asset('frontend') }}/img/news/icon-yo.png"
                                                alt=""></a>
                                    </div>
                                    <div class="follow-count">
                                        <span>8,045</span>
                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{ asset('frontend') }}/img/logo/logo2_footer.png"
                                            alt=""></a>
                                </div>
                                            ...
                                            <div class="form-icon">
                                                <button type="submit" name="submit" id="newsletter-submit"
                                                    class="email_icon newsletter-submit button-contactForm"><img
                                                        src="{{ asset('frontend') }}/img/logo/form-iocn.png"
                                                        alt=""></button>
                                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50 mt-60">
                            ...
                            <div class="instagram-gellay">
                                <ul class="insta-feed">
                                    <li><a href="#"><img src="{{ asset('frontend') }}/img/post/instra1.jpg"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('frontend') }}/img/post/instra2.jpg"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('frontend') }}/img/post/instra3.jpg"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('frontend') }}/img/post/instra4.jpg"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('frontend') }}/img/post/instra5.jpg"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('frontend') }}/img/post/instra6.jpg"
                                                alt=""></a>
                                    </li>
                                </ul>
                            </div>
